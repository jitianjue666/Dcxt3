...
<table class="table">
      ...
      <c:forEach items="${jilu}" var="clazz" varStatus="statee">
       <tr>
       <td class="center">${clazz.ono}</td>
        <td class="center">${clazz.bid}</td>
        
        <td class="center">${clazz.zonghuafei} 元</td>
        <td class="center"><strong class="rmb_icon">${clazz.shijihuafei} 元</strong></td>
        <td class="center">${clazz.zt}</td>

        <td class="center"><a href="getjutidingdan2/${clazz.ono}" class="link_icon" target="_blank">查看详情</a></td>
