  ...
  <div class="m_right">
			...
			<table border="0" class="order_tab" style="width:930px; text-align:center; margin-bottom:30px;" cellspacing="0" cellpadding="0">
              <tr>                                                                                                                                                    
                <td width="155">店铺</td>
                <td width="155">满额</td>
                <td width="155">减免金额</td>
               <td width="155">红包操作</td>
              </tr>
              <c:forEach items="${lcc}" var="clazz" varStatus="statee">
<tr>   
<td>${clazz.sna}</td>
<td>满${clazz.fm} </td>    <td> 减${clazz.mm}</td>
<td><a href="hongbaojindian/${clazz.cid}">立即使用</a></td>
</tr>
</c:forEach>
			</table>
