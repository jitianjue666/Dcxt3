...
<script src="js/jquery.mCustomScrollbar.concat.min.js"></script>
 ...
 $(document).ready(function(){
	 $("#getcaipinfenlei").load("getcaipinfenlei");
      });
 </script>
<script>
...
<div class="rt_content">
      ...
      <form method="post" action="tianjiahongbao" >
      <table class="table">
       <tr>
        <td style="text-align:right;">满额:</td>
        <td>
         <input type="text" class="textbox" value="" name="frommoney"/>
        </td>
        <td style="text-align:right;">减:</td>
        <td>
         <input type="text" class="textbox" value=""name="minusmoney" />
         <span>元</span>
        </td>
        <td>
        <input class="full_link_td" style="line-height:58px" type="submit" value="增加" >
    ...
    <th>满</th>
       ...
       <c:forEach items="${lc}" var="clazz" varStatus="statee">
       <tr>
        <td class="center">>${clazz.frommoney}</td>
        <td class="center">${clazz.minusmoney}</td>
       
        <td class="center">
        <a href="fafang1/${clazz.couponid}"  class="link_icon">给所有用户发放</a></td>
        <td> <a href="fafang2/${clazz.couponid}"  class="link_icon">给所有来过本店消费的用户发放</a>
        </td>
       </tr>
       </c:forEach>
      </table>
