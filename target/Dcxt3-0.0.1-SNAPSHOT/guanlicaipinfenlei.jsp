...
<div class="rt_content">
      <div class="page_title">
       <h2 class="fl">管理菜品分类</h2>
      </div>
      <section>
      <form action="zengjiacaipinfenlei" method="post">
<input type="text" class="textbox textbox_225" name="dcategory"/>
       <input type="submit" value="新增分类" class="group_btn"/>
       </form>
       <div id="getcaipinfenlei">
</div>
