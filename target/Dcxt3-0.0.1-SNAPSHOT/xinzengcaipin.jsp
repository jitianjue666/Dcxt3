...
<section class="rt_wrap content mCustomScrollbar">
 <div class="rt_content">
     ...
     <form action="tianjiacaipin1" method="post">
      <ul class="ulColumn2">
       <li>
        <span class="item_name" style="width:120px;">菜品名称：</span>
        <input type="text" class="textbox textbox_225" name="dishname"/>
        <span class="errorTips">一般不超过80个字符</span>
       </li>
       
       <li>
        <span class="item_name" style="width:120px;">菜品介绍：</span>
        <input type="text" class="textbox textbox_295" name="dishintroduction"/>
        <span class="errorTips">一般不超过200个字符</span>
       </li>
       <li>
        <span class="item_name" style="width:120px;">菜品价格：</span>
        <input type="text" class="textbox textbox_295" name="dishprice"/>
        
       </li>
      
       <li>
        <span class="item_name" style="width:120px;">菜品库存：</span>
        <input type="text" class="textbox textbox_295"name="dishstock"/>
       </li>
       <li id="dcg">
