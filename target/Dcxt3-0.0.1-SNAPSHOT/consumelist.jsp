  ...
  <div class="m_right">
            ...
            <table border="0" class="order_tab" style="width:930px; text-align:center; margin-bottom:30px;" cellspacing="0" cellpadding="0">
             ...
             <c:forEach items="${jilu}" var="clazz" varStatus="statee">
              <tr>
                <td><font color="#ff4e00">${clazz.ono}</font></td>
                <td><img src="shopPic2?w=${clazz.sid}" height="50px" width="50px"  />${clazz.sn} </td>
                <td>￥${clazz.shijihuafei}元</td>
                <td>${clazz.starttime}</td>
                <td>${clazz.overtime}</td>
                <td>${clazz.zt}</td>
                <td><a href="getjutidingdan/${clazz.ono}">查看详情</a></td>
              </tr>
              </c:forEach>
            </table>
