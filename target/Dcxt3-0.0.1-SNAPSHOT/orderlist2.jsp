    	...
    	<table border="0" class="car_tab" style="width:1200px; margin-bottom:50px;" cellspacing="0" cellpadding="0">
          ...
          <tr height="70">
          	<td colspan="6" style="font-family:'Microsoft YaHei'; border-bottom:0;">
                ...
                <span class="fr">菜品总价：<b style="font-size:22px;">${totalprice}元</b></span>
                 <span class="fr">菜品折扣后价格：<b style="font-size:22px; color:#ff4e00;">${totalprice2}元</b></span>
            </td>
          </tr>
          <tr valign="top" height="150">
           <td> <div id="hbs"></div></td>
          	<td colspan="6" align="right">
            	...
            	<a href="../hongbaozhifu/${orderno}"><img src="../images/hongbao.jpg"  style="height:40px;width:100px"/></a>&nbsp; &nbsp; <a href="../xiadan3/${cid }"><img style="height:40px;width:100px" src="../images/buy2.gif" /></a>
            </td>
          </tr>
        </table>
