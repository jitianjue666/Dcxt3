...
<script src="../js/jquery.mCustomScrollbar.concat.min.js"></script>
 ...
 $(document).ready(function(){
	 $("#ttttt").load("../weiwanchengdingdanshu");
	 $("#spzp2").load("../getspzp2");
...
<div class="rt_content">
      ...
      <table class="table">
       <tr>
        <td>下单者： ${buyerid}</td>
        <td>下单时间：${ordertime }</td>
        <td> 付款时间:${ordertime }</td>
       ...
       <tr>
        <td> 完单时间：${overtime }</td>
        <td>原价:${totalprice}元</td>
        <td>使用红包后收入:${totalprice2}元</td>
      ...
      <table class="table">
       ...
       <td>${clazz.dishmingzi}</td>
        <td class="center"><img src="../cptp8?did=${clazz.dishno}" width="50" height="50"/></td>
        
        <td class="center">×${clazz.dishmount}</td>
        <td class="center"><strong class="rmb_icon">${clazz.totalmount}</strong></td>
