  ...
  <div class="content mar_20">
    ...
    <div class="content mar_20">
    	<table border="0" class="car_tab" style="width:1200px; margin-bottom:50px;" cellspacing="0" cellpadding="0">
          <tr>
          <td class="car_th" width="450">满</td>
            <td class="car_th" width="450">减</td>

          
            <td class="car_th" width="150">操作</td>
</tr>
          
          <c:forEach items="${lcoup}" var="clazz" varStatus="statee">
          <tr >
            <td>
            	<div class="c_s_img"  >${clazz.fm}</div>
            ...
            <td align="center" style="color:#ff4e00;"><a href="../xiadan2/${clazz.cid}">立即使用</a></td>
             </tr>
             </c:forEach>
